...
const OurMaid = () => {
    ...
    return (
        <div>
            ...
            <Mobile>
                <div className="relative bg-neutral-200 w-full flex flex-col items-start justify-start pt-[116px] px-0 pb-14 box-border text-left text-xs text-neutral-800 font-fonts-caption-semibold">
                    <div className="self-stretch flex flex-col items-start justify-start p-4 gap-[16px] z-[0]">
                        <div className="self-stretch flex flex-col items-start justify-start gap-[8px] text-neutral-600"> <br />  <br />
                            ...
                            <div className="rounded-corner-radius-12-round bg-neutral-whitepure shadow-[0px_4px_12px_rgba(3,_12,_50,_0.16)] flex flex-col items-start justify-center p-4 box-border gap-[8px] min-w-[256px] text-center text-lg">
                                <div className="overflow-hidden flex flex-col items-start justify-start">
                                    <div className="flex flex-col items-start justify-center gap-[16px]">
                                        ...
                                        {/* <div className="self-stretch rounded-2xl h-11 flex flex-row items-start justify-start text-sm text-maincolors-algawali-secondry-color-dark">
                                        ...
                                        <div className="self-stretch rounded-2xl h-18 flex flex-row items-start justify-start text-sm text-maincolors-algawali-secondry-color-dark">
                                            <div className="flex-1 rounded-corner-radius-8-round flex flex-row items-center justify-center p-3 border-[2px] border-solid border-maincolors-algawali-secondry-color-dark">
                                                <Button className="flex-1" variant="outline-primary">
                                                    See Details
                                                </Button>
                        ...
                        <div className="rounded-corner-radius-12-round bg-neutral-whitepure shadow-[0px_4px_12px_rgba(3,_12,_50,_0.16)] flex flex-col items-start justify-center p-4 box-border gap-[8px] min-w-[256px] text-center text-lg">
                            <div className="w-[295px] flex flex-col items-start justify-start">
                                <div className="self-stretch flex flex-col items-start justify-center gap-[16px]">
                                    <div className="self-stretch flex flex-col items-start justify-center gap-[8px]">
                                        <div className="flex flex-col items-start justify-center gap-[8px]">
                                            <img
                        ...
                        <div className="self-stretch flex flex-col items-start justify-start gap-[8px] text-neutral-600">
